...
本次实验核心逻辑比较简单，但具体实现还是非常复杂的。很多细节实现需要不停查文档，搜索方案，比方说状态图边的注释（即输入符号），需要在边倾斜时也紧邻对应的边，但是文字只能输出在衡平竖直的方框里，我知道QTransform可以实现旋转，但结果于预期不同，后来查到QTransform是绕原点转的，我想让它绕特定点转，找了很久也没有找到改原点方法，花了3个小时才想到，可以通过整体平移把旋转中心移到原点，再旋转，再平移回去就可以了。2D绘图编程还是需要积累经验，如果不熟悉这些技巧，会浪费很多时间。
